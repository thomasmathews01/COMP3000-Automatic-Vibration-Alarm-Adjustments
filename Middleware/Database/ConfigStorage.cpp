...
std::vector<site> ConfigStorage::get_site_data() {
...
std::vector<machine> ConfigStorage::get_machines_for_site(const site& site) {
...
std::vector<channel> ConfigStorage::get_channel_information_for_machine(const machine& machine) {
...
std::vector<channel> ConfigStorage::get_all_channels() {
...
int ConfigStorage::get_machine_id_from_channel_id(int channel_id) {
