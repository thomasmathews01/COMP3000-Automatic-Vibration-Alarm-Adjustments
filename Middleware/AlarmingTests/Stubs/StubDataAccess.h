...
public:
	std::vector<std::pair<time_point_t, float>> get_data(int channel, int type, time_point_t start, time_point_t end) const noexcept final;

	std::vector<float> get_data_points_only(int channel, int type, time_point_t start, time_point_t end) const noexcept final;
    ...
    std::vector<int> get_all_data_types() const noexcept final;
